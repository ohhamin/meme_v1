        ...
        try:
            response = await self.client.responses.create(
                ...
                instructions=(
                    ...
                    "A proposal may only refine the evidence-extraction/context-quality layer: for example, how missing, "
                    "stale, weakly sourced, contradictory, or indirect news/macro/fundamental evidence should be classified. "
                    ...
                    "A proposal must be a Markdown evidence/context rule, never executable code. "
