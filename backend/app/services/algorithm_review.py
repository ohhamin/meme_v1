        ...
        try:
            response = await self.client.responses.create(
                ...
                instructions=(
                    ...
                    "average realized return compared with higher bands, you may propose raising the minimum BUY score "
                    "or reducing exposure for that band. When evidence is mixed, propose no change. "
                    ...
                    "A proposal must be a Markdown strategy rule, never executable code. "
