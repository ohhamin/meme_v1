...
class QuantSignalService:
    ...
    def enrich(
        ...
        *,
        ...
        if market == "stock":
            short_h, medium_h, long_h = 5, 20, 60
            ...
            anchor = medium_m * 0.43 + long_m * 0.57
            ...
            penalty = 0.0
            # Very sharp 5-day moves are treated as execution risk rather than
            # an additional positive momentum signal.
            if short_m >= 85:
                penalty += (short_m - 85) * 0.35

            target_vol = 2.0
            components = (
                f"60일 모멘텀 {long_m:.0f} · "
                f"20일 모멘텀 {medium_m:.0f} · "
